...
\textbf{Demostración}
    \begin{itemize}
        ...
        \item Entonces si acotamos la cantidad de veces que un lado que un lado se vuelve crítico, habremos acotado la cantidad de caminos aumentantes
    \end{itemize}
    ...
    \begin{itemize}
        \item \textbf{Caso 1. En el que se satura (forward)}: Como se saturó en el paso $k$ entonces:
            ...
            \begin{itemize}
                ...
                \item Se saturó, como luego del paso $k$ ya se saturó, para saturarse de nuevo debemos haberle el flujo en un paso $i$, con $k<i<j$.
            \end{itemize}
