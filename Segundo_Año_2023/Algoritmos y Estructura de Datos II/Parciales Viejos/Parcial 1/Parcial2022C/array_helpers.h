...
/**
 * @brief calculates how much extra fee the company has to pay.
 * @param[in] a array
 * @param[in] hour A value between 0 and 23 that represents the hour to
 *                 compute the extra space fee cost.
 * @details
 *   Counts items arrived until `hour` (inclusive).
